...
The foundations of pathfinding can be traced to graph theory, beginning with Euler's solution to the Königsberg Bridge Problem in 1736. By representing locations as vertices and connections as edges, Euler established a mathematical framework for studying networks.
...
Because the locations possess natural geographic coordinates, Euclidean distance provided an effective heuristic. A* produced the same optimal routes as Dijkstra's Algorithm while exploring fewer vertices.
