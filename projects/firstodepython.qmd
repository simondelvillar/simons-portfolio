...
description: "One of my first write-ups!"
categories:
  - Mathematics
  - Physics 
  - Python 
...
h = 0.0001
steps = 200
t_vals, V_num = euler(0, 0, h, steps)
V_ex = [exact(t) for t in t_vals]

# Error
errors = [abs(a - b) for a, b in zip(V_num, V_ex)]

# Plot sol'ns
plt.figure()
plt.plot(t_vals, V_num, label="Euler Approximation")
plt.plot(t_vals, V_ex, '--', label="Exact Solution")
plt.xlabel("Time (s)")
plt.ylabel("Voltage (V)")
plt.legend()
plt.title("RC Circuit: Numerical vs Exact")
...
plt.xlim(0, 0.0015)  
plt.ylim(0, 3)  
plt.savefig('zoomedplot.png')     

# Plot error
plt.figure()
plt.plot(t_vals, errors)
plt.xlabel("Time (s)")
plt.ylabel("Error")
